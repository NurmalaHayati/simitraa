...
<head>
    <title>Daftar Survei | Simitra</title>
...
<body>
                ...
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item" style="background-color: #1a9bfc; border-radius: 9px"> <a
                            ...
                            aria-expanded="false"><i class="mdi mdi-file-document-box text-white"></i><span
                                class="hide-menu text-white">Daftar Survei</span></a></li>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb" style="padding-bottom: 0; padding-top: 0;">
            <div class="row align-items-center">
                <div class="col-6">
                    ...
                    <h1 class="mb-0 fw-bold">Daftar Survei</h1>
                </div>
                <div class="col-6">
        ...
        <?php if ($pesan == 200) : ?>
        <script>
        swal("Berhasil!", "Data Survei Telah Ditambahkan!", "success");
        </script>
        <?php elseif ($pesan == 300) : ?>
        <script>
        swal("Gagal!", "Data Survei Gagal Ditambahkan!", "error");
        </script>
        <?php elseif ($pesan == 201) : ?>
        <script>
        swal("Berhasil!", "Update Data Survei Berhasil Dilakukan!", "success");
        </script>
        <?php elseif ($pesan == 301) : ?>
        <script>
        swal("Gagal!", "Data Survei Gagal Diupdate!", "warning");
        </script>
        <?php elseif ($pesan == 202) : ?>
        <script>
        swal("Berhasil!", "Hapus Data Survei Berhasil Dilakukan!", "success");
        </script>
        <?php elseif ($pesan == 302) : ?>
        <script>
        swal("Gagal!", "Data Survei Gagal Dihapus!", "error");
        </script>
        <?php endif; ?>
        <?php endif;
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="EditLabel">Edit Survei</h5>
                    ...
                    <form action="../model/edit-lowongan.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 row">
                                <label for="gambar" class="col-md-4 col-form-label">Gambar Survei</label>
                                <div class="col-sm-8">
        ...
        <div class="modal fade " id="Delete<?= $row['id']; ?>" tabindex="-1" aria-labelledby="DeleteLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Anda yakin ingin menghapus survei <strong><?= $row['jenis_lowongan']; ?></strong>?
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade " id="Detail<?= $row['id']; ?>" tabindex="-1" aria-labelledby="DetailLabel"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="DetailLabel">Detail Survei</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade " id="TambahLowongan" tabindex="-1" aria-labelledby="TambahLowonganLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="TambahLowonganLabel">Tambah Survei</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="../model/tambah-lowongan.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3 row">
                                <label for="Jenis" class="col-md-4 col-form-label">Nama Survei</label>
                                <div class="col-sm-8">
